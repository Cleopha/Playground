    ...
    return (
        <Stack direction="column" mr='1'>
            ...
            <AutoComplete openOnFocus multiple onChange={handleMultiselectChange}>
                <AutoCompleteInput bg="#232934" _hover={{ backgroundColor: '#272d38' }} _placeholder={{ color: 'gray.500' }} placeholder="County Search..." variant="filled" textColor={"white"} mb='2'>
                    {({ tags }) =>
                        tags.map((tag, tid) => (
                            <AutoCompleteTag
                                bg='gray.300'
