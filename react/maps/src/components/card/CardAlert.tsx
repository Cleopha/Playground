...
export const CardAlert = forwardRef((props: CardAlertProps, ref: Ref<HTMLDivElement>) => {
  ...
  return (
    <Box
      ...
      m='1'
      bg={selectedMarker && selectedMarker.id === alert.id ? "whiteAlpha.300" : ""}
      ...
      <Flex direction="column" pr="2" pb="2" pl="2">
        ...
        >
          <HStack mb={{ base: "2", md: "0" }}>
            <Text textColor={"gray.200"} fontSize="sm" fontWeight="bold" display={{ base: "none", md: "block" }}>
              Department:
            </Text>
            <Text textColor={"red.100"}>{alert.department}</Text>
          </HStack>
